...
<p>Para começar o desenvolvimento você precisa ter o Node.js <strong>16</strong> ou superior instalado! <br><br>

Se estiver no Windows você pode instalar <a href="https://nodejs.org">aqui</a>

Se estiver no Linux recomendo usar o <a href="https://github.com/nvm-sh/nvm">nvm(Node Version Manager)</a> <strong>Lembrando a aplicação usa Node.js 16</strong> então lembre-se de usar:
</p>
